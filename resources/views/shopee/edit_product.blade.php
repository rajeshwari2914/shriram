...
@section('index-content')
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <!-- /. ROW  -->
                <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12" id="myFrame">
               <div class="panel panel-info">
                        <div class="panel-heading">
                           Customer Form
                        </div>
                        <div class="panel-body">
                            <form  method="post" action="{{route('details.update',$shri->id)}}" enctype="multipart/form-data">
							@csrf
                            @method('PUT')
                                <div class="col-md-12">
                                        <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="contact" pattern="[0-9]{10}" title="Enter Valid Number" value="{{$shri->mobile}}">
										</div>
                                        </div>
                                </div>
                                <div class="col-md-12">
							            ...
							            <div class="form-group">
                                            ...
                                            <select class="form-control materialname" type="text" name="material" required>
                                                ...
                                                <option value="{{$shri->material}}">{{$shri->material}}</option>
                                        ...
                                        <div class="form-group">
                                                ...
                                                <textarea class="form-control summernote" style="word-spacing:1cm;padding-top:1cm;line-height: 500%;letter-spacing:5px;" name="desc">{{$shri->desc}}</textarea>
                                            </div>
                                        </div>
                                </div>
                                <!-- <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                            ...
                                            <select class="form-control" type="text" name="iron">
                                                <option value="{{$shri->estri}}">{{$shri->estri}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="pmap" value="{{$shri->pendri}}">
										</div>
                                        </div>
                                        <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Ring</label>
                                            <input class="form-control" type="text" name="ring" value="{{$shri->ring}}">
										</div>
                                        </div>
                                        <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Paint Quantity</label>
                                            <input class="form-control material_pqty" type="number" name="pqty" value="{{$shri->material_qty}}">
										</div>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="collar_size" value="{{$shri->coller_size}}">
									</div>
                                    </div>
                                        <!-- <div class="col-md-4">
							            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control material_qty" type="number" name="mqty" value="{{$shri->material_qty}}">
										</div>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="bound_size" value="{{$shri->bound_patti_size}}">
									</div>
                                    </div>
                                        <!-- <div class="col-md-4">
							            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control material_qty" type="number" name="kqty" value="{{$shri->material_qty}}">
										</div>
                                        </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <center><input type="submit" class="btn btn-info" style="padding:10px;width:20%;" value="Update Customer Details"></center>
                                </form>
                            </div>
                        </div>
                            </div>
...
$(document).ready(function(){
    ...
    if(pk=='Shirt')
        ...
        else if(pk=='Paint')
        {
            ...
            $('.kurtapoint').css("display","none");
        }else if(pk=='Kurta' || pk=='Nehru_shirt')
        {
            $('.paintpoint').css("display","none");
            $('.shirtpoint').css("display","none");
